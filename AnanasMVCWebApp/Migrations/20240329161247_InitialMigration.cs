    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSKU", x => new { x.SizeId, x.ProductVariantId });
                    table.ForeignKey(
                        name: "FK_ProductSKU_ProductVariants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductSKU_Sizes_SizeId",
                        column: x => x.SizeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSKU_ProductVariantId",
                table: "ProductSKU",
